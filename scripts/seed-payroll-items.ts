...
const DEDUCTIONS = [
  { itemCode: '01', itemName: '소득세', displayOrder: 1, calcFormula: '소득세(계산항목)' },
  { itemCode: '02', itemName: '지방소득세', displayOrder: 2, calcFormula: '소득세 × 10%', calcDescription: '소득세의 10%' },
  { itemCode: '03', itemName: '국민연금', displayOrder: 3, calcFormula: '기준소득월액 × 4.75%', calcDescription: '과세급여(하한 40만·상한 637만) × 4.75%' },
